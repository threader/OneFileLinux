...
Other hardening features are to be explored like HardenMalloc, Fil-C and 'pkgsrc' with the bsd emulation library - where some persistant storage would be nice... - once thigs are running as I intend.
